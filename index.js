...
const UUID = process.env.UUID || '61dc5698-c20a-4a58-ba0a-b9aaea2e375e'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'GqcLuORdMs9n2hCGIz4TZ9serBcscMDX';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
